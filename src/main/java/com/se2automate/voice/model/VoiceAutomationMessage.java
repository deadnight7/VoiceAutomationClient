package com.se2automate.voice.model;
 ...
 * voiceFilePath - read in HTTP requests to play the voice files
 * <p>
...
public class VoiceAutomationMessage {
     ...
     * @param status        - status of the request
     * @param message       - the message
     * @param voiceFilePath - filepath of the voice
     */
     ...
     *
     * @param voiceFilePath - file paths or names to voice files
     */
